...
#setwd
os.chdir('C:/Users/xd944/Documents/20171212/retinex/ANN-result/')
...
for a in range(1,6):
    ...
    plt.savefig("ANN_Accuracy_retinex_"+str(a)+".png")
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'test'], loc='upper left')
    plt.savefig("ANN_Loss_retinex_"+str(a)+".png")
    
    classifier.save('20171212_ANN_retinex_'+str(a)+'.h5')
